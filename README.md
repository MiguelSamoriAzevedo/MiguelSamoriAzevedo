...
## Sobre mim
Após 34 anos de experiência e construir uma carreira sólida na área de **Contabilidade**, Docência e **Consultoria Empresarial** recentemente, fiz uma **transição de carreira** para a área de Tecnologia da Informação. Me tornei **Programador Full Stack**, com foco em desenvolvimento de sistemas web, Bancos de dados, Mobile e AI.
...
- **Linguagens de Programação**: JavaScript, HTML, CSS, SQL, TypeScript
- **Frameworks e Bibliotecas**: React, Node.js, NextJs, Vue
